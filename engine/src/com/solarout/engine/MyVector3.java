...
public class MyVector3 implements Serializable {
    ...
    public final static MyVector3 X = new MyVector3(1, 0, 0);
    public final static MyVector3 Y = new MyVector3(0, 1, 0);
    public final static MyVector3 Z = new MyVector3(0, 0, 1);
    public final static MyVector3 Zero = new MyVector3(0, 0, 0);
    ...
    public MyVector3 (final MyVector3 vector) {
        this.set(vector);
    }
    ...
    public MyVector3 (final double[] values) {
     ...
     * @param vector The vector
     * @param z The z-component */
    public MyVector3 (final Vector2 vector, double z) {
    ...
    public MyVector3 set (double x, double y, double z) {
        this.x = x;
        this.y = y;
        this.z = z;
        return this;
    ...
    public MyVector3 set (final MyVector3 vector) {
     ...
     * @param values The array
     * @return this vector for chaining */
    public MyVector3 set (final double[] values) {
     ...
     * @param z The z-component
     * @return This vector for chaining */
    public MyVector3 set (final Vector2 vector, double z) {
        return this.set(vector.x, vector.y, z);
    }

    
    public MyVector3 cpy () {
        return new MyVector3(this);
    }

    
    public MyVector3 add (final MyVector3 vector) {
     ...
     * @return This vector for chaining */
    public MyVector3 add (double values) {
        return this.set(this.x + values, this.y + values, this.z + values);
    }

    
    public MyVector3 sub (final MyVector3 a_vec) {
     ...
     * @return This vector for chaining */
    public MyVector3 sub (double value) {
        return this.set(this.x - value, this.y - value, this.z - value);
    }

    
    public MyVector3 scl (double scalar) {
        return this.set(this.x * scalar, this.y * scalar, this.z * scalar);
    }

    
    public MyVector3 scl (final MyVector3 other) {
     ...
     * @param vz Z value
     * @return This vector for chaining */
    public MyVector3 scl (double vx, double vy, double vz) {
        return this.set(this.x * vx, this.y * vy, this.z * vz);
    }

    
    public MyVector3 mulAdd (MyVector3 vec, double scalar) {
        this.x += vec.x * scalar;
        this.y += vec.y * scalar;
        this.z += vec.z * scalar;
        return this;
    ...
    public MyVector3 mulAdd (MyVector3 vec, MyVector3 mulVec) {
    ...
    public boolean idt (final MyVector3 vector) {
    ...
    public double dst (final MyVector3 vector) {
    ...
    public double dst2 (MyVector3 point) {
    ...
    public double dot (final MyVector3 vector) {
        return x * vector.x + y * vector.y + z * vector.z;
    }
     ...
     * @param vector The other vector
     * @return This vector for chaining */
    public MyVector3 crs (final MyVector3 vector) {
     ...
     * @param z The z-component of the other vector
     * @return This vector for chaining */
    public MyVector3 crs (double x, double y, double z) {
     ...
     * @return This vector for chaining */
    public MyVector3 mul4x3 (double[] matrix) {
    ...
    public boolean isOnLine (MyVector3 other, double epsilon) {
        return len2(y * other.z - z * other.y, z * other.x - x * other.z, x * other.y - y * other.x) <= epsilon;
    }

    
    public boolean isOnLine (MyVector3 other) {
        return len2(y * other.z - z * other.y, z * other.x - x * other.z, x * other.y - y * other.x) <= MathUtils.FLOAT_ROUNDING_ERROR;
    }

    
    public boolean isCollinear (MyVector3 other, double epsilon) {
        return isOnLine(other, epsilon) && hasSameDirection(other);
    }

    
    public boolean isCollinear (MyVector3 other) {
        return isOnLine(other) && hasSameDirection(other);
    }

    
    public boolean isCollinearOpposite (MyVector3 other, double epsilon) {
        return isOnLine(other, epsilon) && hasOppositeDirection(other);
    }

    
    public boolean isCollinearOpposite (MyVector3 other) {
        return isOnLine(other) && hasOppositeDirection(other);
    }

    
    public boolean isPerpendicular (MyVector3 vector) {
        return MathUtils.isZero((float)dot(vector));
    }

    
    public boolean isPerpendicular (MyVector3 vector, double epsilon) {
        return MathUtils.isZero((float) dot(vector), (float)epsilon);
    }

    
    public boolean hasSameDirection (MyVector3 vector) {
        return dot(vector) > 0;
    }

    
    public boolean hasOppositeDirection (MyVector3 vector) {
        return dot(vector) < 0;
    }

    
    public MyVector3 lerp (final MyVector3 target, double alpha) {
        scl(1.0f - alpha);
        add(target.x * alpha, target.y * alpha, target.z * alpha);
        return this;
    }
    
    public MyVector3 interpolate (MyVector3 target, double alpha, Interpolation interpolator) {
     ...
     * @return This vector for chaining. */
    public MyVector3 slerp (final MyVector3 target, double alpha) {
    ...
    public MyVector3 limit (double limit) {
        return limit2(limit * limit);
    }

    
    public MyVector3 limit2 (double limit2) {
        double len2 = len2();
        if (len2 > limit2) {
            scl(limit2 / len2);
        }
    ...
    public MyVector3 setLength ( double len ) {
        return setLength2( len * len );
    }

    
    public MyVector3 setLength2 ( double len2 ) {
        double oldLen2 = len2();
    ...
    public MyVector3 clamp (double min, double max) {
    ...
    public boolean epsilonEquals (final MyVector3 other, double epsilon) {
